...
- six or more [Bootstrap modals](https://www.w3schools.com/bootstrap/bootstrap_modal.asp){:target="_blank"} that open when you click a thumbnail and show the full size photo
...
- *** MUST use a Google Font for the About Us, Meetings, and Sign Up headings. Leave the indented text as a normal font. Helpful links: [fonts.google.com](https://fonts.google.com/) and [w3schools How To Google Fonts](https://www.w3schools.com/howto/howto_google_fonts.asp){:target="_blank"}

------

If you have completed 1 or more Computer Science courses, pick one of the following:

1. only use one image modal, but create [a photo slideshow/carousel](https://www.w3schools.com/howto/howto_js_slideshow.asp){:target="_blank"} with all of the photos on that modal
1. use [collapsibles/accordion](https://www.w3schools.com/howto/howto_js_accordion.asp){:target="_blank"} to clean up the info section
