...
Create a math game with FIVE question.
...
Either:
    - create a simple MathQuestion class and store your question/answer pairs in an array of type MathQuestion[]
    - OR use parallel arrays. one array with questions and one array with answers


## The Question Format

Question 1 MUST be any simple math problem that is answered with a number...
  - What is 3 + 4? 
  - What is 6 / 2?
