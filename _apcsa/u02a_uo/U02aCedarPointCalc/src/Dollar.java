...
public class Dollar {
    ...
    /**
     * Returns a new Dollar amount that equals this {@code Dollar} object minus the other {@code Dollar} object.
     *
     * @param other the {@code Dollar} object to subtract
     * @return a new {@code Dollar} object representing the difference
     */
    ...
    /**
     * Returns a new Dollar amount that equals this {@code Dollar} object times the double multiplier.
     *
     * @param multiplier the decimal amount that we will multiply by
