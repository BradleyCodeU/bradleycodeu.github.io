...
public class Test_U01aPaintCalcIntOnly {
    // WALL AREA TESTS
    @Test
    public void testCalculateWallArea() {
        ...
        int actualArea = U01aPaintCalcIntOnly.calculateWallArea(length, width, height, num_doors, num_windows);
    ...
    public void testCalculatePaintGallons() {
        ...
        int actualGallons = U01aPaintCalcIntOnly.calculatePaintGallons(total_area);
