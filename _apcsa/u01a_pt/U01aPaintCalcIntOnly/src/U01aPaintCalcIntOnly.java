...
public class U01aPaintCalcIntOnly {
  ...
  {
    // TODO Calculate the number of gallons of paint needed
    // Assume that 1 gallon can of paint will cover 400 square feet PLUS always buy 1 extra
    // For example...
    // calculatePaintGallons(350) --> 1
    // calculatePaintGallons(432) --> 2
    return 0;
  }

  public static int calculateCostEstimate(int gallons_needed, int price_per_gallon, int sales_tax_percent)
  {
    // TODO Calculate the total cost including sales tax PLUS 1
    // Beware of integer division when you try to calculate the sales tax
    // For example...
    // calculateCostEstimate(2, 16, 10) --> 36
    // calculateCostEstimate(4, 16, 10) --> 71
