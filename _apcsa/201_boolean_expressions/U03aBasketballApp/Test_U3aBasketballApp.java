...
class Test_U03aBasketballApp {
    ...
    void haveSameJerseyNumber_SameNumber_Test() {
        ...
        assertTrue(U03aBasketballApp.haveSameJerseyNumber(player1, player2));
    }
    ...
    void haveSameJerseyNumber_DifferentNumber_Test() {
        ...
        assertFalse(U03aBasketballApp.haveSameJerseyNumber(player1, player2));
    }
    ...
    void areOnSameTeam_SameTeam_Test() {
        ...
        assertTrue(U03aBasketballApp.areOnSameTeam(player1, player2));
    }
    ...
    void areOnSameTeam_DifferentTeam_Test() {
        ...
        assertFalse(U03aBasketballApp.areOnSameTeam(player1, player2));
    }
    ...
    void areOnSameTeam_Null_Test() {
        ...
        assertFalse(U03aBasketballApp.areOnSameTeam(player1, player2));
        assertFalse(U03aBasketballApp.areOnSameTeam(player2, player1));
    }
    ...
    void areInSameLocation_SameLocation_Test() {
        ...
        assertTrue(U03aBasketballApp.areInSameLocation(player1, player2));
    }
    ...
    void areInSameLocation_DifferentLocation_Test() {
        ...
        assertFalse(U03aBasketballApp.areInSameLocation(player1, player2));
    }
    @Test
    void areInSameLocation_Null_Test() {
        ...
        assertFalse(U03aBasketballApp.areInSameLocation(player1, player2));
        assertFalse(U03aBasketballApp.areInSameLocation(player2, player1));
    }
    ...
    void findDistance_Test() {
        ...
        assertEquals(5.0, U03aBasketballApp.findDistance(player1, player2));
        assertEquals(0.0, U03aBasketballApp.findDistance(player1, player1));
    }
    @Test
    void test_findDistanceNull() {
        ...
        assertEquals(-1.0, U03aBasketballApp.findDistance(player1, player2));
