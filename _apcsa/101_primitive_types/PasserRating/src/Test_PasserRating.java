...
public class Test_PasserRating {
    ...
    public void testCalculateNFLRating_TomBrady() {
        ...
        double actualNFLRating = PasserRating.calculateNFLRating(attempts, completions, yards, touchdowns, interceptions);
    ...
    public void testCalculateCollegeRating_TomBrady() {
        ...
        double actualCollegeRating = PasserRating.calculateCollegeRating(attempts, completions, yards, touchdowns, interceptions);
