...
public class Test_KingsIsland {
    ...
    public void testCalculateTotalCost() {
        ...
        double actualTotalCost1 = KingsIslandApp.calculateTotalCost(num_people1, ticket_cost1, parking_cost1, gas_cost1);
    ...
    public void testCalculateTotalCost2() {
        ...
        double actualTotalCost2 = KingsIslandApp.calculateTotalCost(num_people2, ticket_cost2, parking_cost2, gas_cost2);
    ...
    public void testCalculateCostPerPerson() {
        ...
        double actualCostPerPerson1 = KingsIslandApp.calculateCostPerPerson(total_cost1, num_people1);
    ...
    public void testCalculateCostPerPerson2() {
        ...
        double actualCostPerPerson2 = KingsIslandApp.calculateCostPerPerson(total_cost2, num_people2);
