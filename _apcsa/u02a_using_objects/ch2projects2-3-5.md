...
![rectangle being resized so that it has twice the size and the same top-left corner as the original](/apcsa/u02a_using_objects/Java Resize Rect.jpg)
...
![rectangle being resized so that it has half the width and is centered in the original square](/apcsa/u02a_using_objects/Java Resize Rect2.jpg)
