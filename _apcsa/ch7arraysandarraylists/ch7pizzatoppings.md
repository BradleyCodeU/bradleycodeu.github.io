...
Displaying the list using the for each method...
Pepperoni, Pineapple, Sausage, Black Olives, 
```
...
// Step 4: Search the array using a TRADITIONAL FOR loop to determine if the string is already in the arraylist
...
//      Prompt user for a pizza topping to remove from the array and tell them what sentinel value will allow them to quit
        System.out.print("Gimme a pizza topping to remove from the list or type Q to quit: ");
