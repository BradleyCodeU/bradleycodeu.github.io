...
class U9aVirtualPetGame {
    ...
    private static boolean performAction(Scanner input, Pet[] pets, int petNumber, String action) {
  ...
  public static void main(String[] args) {
      ...
      while (true) {
          ...
          int petNumber = selectPet(input, pets);
          System.out.println(". . . . . . . . . . . .\n");
          ...
          String action = "";
          boolean actionFound = performAction(input, pets, petNumber, action);
          if (!actionFound) {
