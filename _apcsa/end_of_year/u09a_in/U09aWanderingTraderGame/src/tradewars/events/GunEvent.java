...
public class GunEvent extends Event {
  ...
  public GunEvent(U09aWanderingTraderGame game) {
    super(game);
    message = new Message(String.format("Would you like to buy a better sword for %s?", CURRENCY_FORMATTER.format(COST)));
  }
