...
When you call it, it has no argument label. That’s not a problem because `print("Banana")` makes sense on its own.

Besides, it’s awkward to read `print(thingToPrint: "Banana")` and `thingToPrint` doesn't add any information.
