/*:
 ...
 As you can see below, trying to assign a new value to a constant is considered an error. The error is “Cannot assign to value: 'name' is a 'let' constant”. Now that you know more about what `let` and _constant_ mean, this error makes sense.
*/
let name = "Johnny"
name = "John"
/*:
...
### Should you always accept a Fix-it?
