...
console.assert(unknownPrediction.includes("UNKNOWN"), "predict should use 'UNKNOWN' when no match found");
...
console.assert(
  mockDisplayLog[1].textString.includes("are") || mockDisplayLog[1].textString.includes("UNKNOWN"),
